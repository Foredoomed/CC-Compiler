...
*/
char * hash_lookup(const hash_t *tptr, const char *key) {
  int h;
  hash_node_t *node;
...
*/
int hash_insert(hash_t *tptr, const char *key, char *data) {
  char *tmp;
  hash_node_t *node;
  int h;
...
*/
char *hash_delete(hash_t *tptr, const char *key) {
